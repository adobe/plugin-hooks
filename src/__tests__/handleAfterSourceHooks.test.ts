...
import getAfterSourceHookHandler, { AfterSourceHookBuildConfig } from '../handleAfterSourceHooks';
...
describe('getAfterSourceHookHandler', () => {
	test('should return afterSourceHook function', async () => {
		...
		expect(getAfterSourceHookHandler(mockConfig)).toBeTypeOf('function');
	});
	...
	describe('should call hook without error', () => {
		...
		test('with empty afterSource array', async () => {
			const mockConfig: AfterSourceHookBuildConfig = {
				memoizedFns: {},
				baseDir: '',
				logger: mockLogger,
		...
		test('with undefined afterSource', async () => {
			const mockConfig: AfterSourceHookBuildConfig = {
				memoizedFns: {},
				baseDir: '',
				logger: mockLogger,
